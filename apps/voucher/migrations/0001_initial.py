            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        verbose_name="Usage",
                        choices=[
                            ("Single use", "Can be used once by one customer"),
                            (
                                "Multi-use",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, verbose_name="Times added to basket"
                    ),
                ),
                (
                    "num_orders",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Times on orders"
                    ),
                ),
                (
                    "total_discount",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order",
                    models.ForeignKey(
                        verbose_name="Order", to="order.Order", on_delete=models.CASCADE
                    ),
                ),
                (
                    "user",
