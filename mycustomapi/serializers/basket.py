...
from mycustomapi.serializers.fields import TaxIncludedDecimalField
...
class BasketLineSerializer(OscarHyperlinkedModelSerializer):
    ...
    # image = DrillDownHyperlinkedIdentityField(
    #     view_name="product-detail", extra_url_kwargs={"product_pk": "product_id"}
    # )

    # description = DrillDownHyperlinkedIdentityField(
    #     view_name="product-detail", extra_url_kwargs={"product_pk": "product_id"}
    # )
